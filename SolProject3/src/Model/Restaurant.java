...
public class Restaurant implements Serializable {
	...
	// save static fields (counters) in locals variables
	private int componentCounter = 1;
	private int cookCounter = 1;
	private int customerCounter = 1;
	private int deliveryCounter = 1;
	private int deliveryAreaCounter = 1;
	private int deliveryPersonCounter = 1;
	...
	public void SaveAllCounters() {
		...
		setCookCounter(Cook.getIdCounter());
		setCustomerCounter(Customer.getIdCounter());
		setDeliveryCounter(Delivery.getIdCounter());
	...
	public void SetAllCounters() {
		...
		Cook.setIdCounter(cookCounter);
		Customer.setIdCounter(customerCounter);
		Delivery.setIdCounter(deliveryCounter);
		DeliveryArea.setIdCounter(deliveryAreaCounter);
		DeliveryPerson.setIdCounter(deliveryPersonCounter);
		Dish.setIdCounter(dishCounter);
